...
description: |
  In this exercise, I learned how to edit a web article by using distill for RMarkdown.
author:
  - name: Fei Jiahui 
    url: https://www.linkedin.com/in/jiahui-fei-169841109/
    affiliation: SMU MITB (Financial Technology and Analytics)
...
First, let us import the data into R by using [*read_csv()*](https://readr.tidyverse.org/reference/read_delim.html)  of [**readr**](https://readr.tidyverse.org/) package.  
